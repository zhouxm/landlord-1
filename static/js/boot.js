...
PG.Preloader = {
    ...
    create: function () {
        ...
        console.log("boot Preloader create:", jsonVal);
        if (jsonVal) {
...
PG.Login = {
    create: function () {
        ...
        style = {font: "22px Arial", fill: "#f00", align: "center"};
    ...
    onLogin: function () {
        ...
        const body = {username:encodeURIComponent(this.username.value),password: encodeURIComponent(this.password.value)};
